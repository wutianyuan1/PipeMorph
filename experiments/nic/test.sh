...
if [ "$MODEL" == "14B" ]; then
    ...
    export TRAIN_SAMPLES=$(( $DP_SIZE * 360 * 20)) # 300 iterations
...
python $REPO_PATH/experiments/nic/set_trace.py --iter "50,100,150,200,250"
export OUT_DIR="$REPO_PATH/experiments/nic/$MODEL/$METHOD"
mkdir -p "$OUT_DIR"
