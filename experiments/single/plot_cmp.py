...
if __name__ == '__main__':
    ...
    for i, method in enumerate(METHODS):
        path = f"experiments/single/7B/{method}/2_3/0.03"
    ...
    plt.tight_layout()
    plt.savefig(f"experiments/single/cmp.png", bbox_inches='tight', bbox_extra_artists=(legend,))
    plt.savefig(f"experiments/single/cmp.pdf", bbox_inches='tight', bbox_extra_artists=(legend,))
