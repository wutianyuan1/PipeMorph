...
export LD_PRELOAD=/$USR_HOME/workspace/PipeMorph-Ext-Exp/zerobubble/megatron/core/failslow_injection/libinjection.so

cd /root/workspace/PipeMorph-Ext-Exp
python ./zerobubble/utils/clear_shm.py
./zerobubble/examples/pipemorph_ext_exp.sh
