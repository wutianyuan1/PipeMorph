...
export LD_PRELOAD=/home/$USR_HOME/workspace/PipeMorph-Ext-Exp/zerobubble/megatron/core/failslow_injection/libinjection.so
export ENABLE_ZERO_BUBBLE=1
export CUDA_DEVICE_MAX_CONNECTIONS=1

cd /home/$USR_HOME/workspace/PipeMorph-Ext-Exp/zerobubble
source ~/.bashrc
echo `pwd`
echo $SLURM_NODELIST
DIR=`pwd`
...
DATASET="/home/$USR_HOME/workspace/PipeMorph-Ext-Exp/zerobubble/zb_sample_dataset/dataset/c4_text_document"
...
if [ ! -e "$DATASET"".idx" ]; then
  ...
  tar -xvf zb_sample_dataset.tar.gz -C /home/$USR_HOME/workspace/PipeMorph-Ext-Exp/zerobubble/
fi
...
options=" \
  ...
  --tokenizer-model /home/$USR_HOME/workspace/PipeMorph-Ext-Exp/zerobubble/zb_sample_dataset/tokenizers/tokenizer.model \
  --split 98,2,0 \
  --clip-grad 8.0 \
  --weight-decay 0.1 \
  --adam-beta1 0.9 \
